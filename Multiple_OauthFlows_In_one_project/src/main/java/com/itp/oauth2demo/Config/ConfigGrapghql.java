...
@Configuration
public class ConfigGrapghql {

    @Bean
    public SecurityFilterChain securityFilterChainGrapghql(HttpSecurity http) throws Exception {

        return http.securityMatcher("/api/graphql/**")
    ...
    JwtIssuerAuthenticationManagerResolver authenticationManagerResolver = JwtIssuerAuthenticationManagerResolver
            .fromTrustedIssuers("http://0.0.0.0:8080/realms/grphql_relam");
